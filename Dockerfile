...
RUN wget -nc https://dl.winehq.org/wine-builds/ubuntu/dists/jammy/winehq-jammy.sources -O /etc/apt/sources.list.d/winehq-jammy.sources
...
WORKDIR /home/wine/.mt4/drive_c

COPY mt4/metaeditor.exe ./mt4/metaeditor.exe
COPY mt4-zmq/Include ./mt4/Include
